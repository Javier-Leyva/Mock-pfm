...
public interface ApplicationApi {
    ...
    @ApiOperation(value = "postPermissions", nickname = "postPermissions", notes = "Copies the permissions from one application to another", response = PermissionsResponse.class, tags={ "Aggregations", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "SUCCESFUL OPERATION", response = PermissionsResponse.class),
